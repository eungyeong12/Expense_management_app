...
import static com.budget.MainActivity.addItemDialog;
import static com.budget.MainActivity.currentUser;
import static com.budget.MainActivity.isDateChange;
import static com.budget.MainActivity.mAuth;
import static com.budget.MainActivity.onItemClick;
import static com.budget.MainActivity.position;
    ...
    public void onBindViewHolder(@NonNull ListAdapter.ListViewHolder holder, int i) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                onItemClick = true;
                addItemDialog = new ItemHandler(view.getContext());
                addItemDialog.show();
